    ...
    async create(@Req() req: Request, @Res() res: Response, @Body() postData: CreateReimbursementSubmitFormInput, @UploadedFile() file: Express.Multer.File) {
        try {
            ...
            if (postData?.notes) {
                ...
                await this.translatorService.DynamicEngJsonData('Reimbursements', resultedData['org_id'], dynamicData, 'Add', 'SubmittedForms', resultedData['form_id'],resultedData['user_id']);
            }
    ...
    async update(@Req() req: Request, @Res() res: Response, @Body() postData: UpdateReimbursementSubmitFormInput, @UploadedFile() file: Express.Multer.File) {
        try {
            ...
            if (postData?.decline_reason) {
                ...
                await this.translatorService.DynamicEngJsonData('Reimbursements', recordDetails?.org_id, dynamicData, 'Add', 'SubmittedForms', recordDetails['form_id'],recordDetails['user_id']);
            }
