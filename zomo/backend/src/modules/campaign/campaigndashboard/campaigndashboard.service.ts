...
export class CampaignDashboardService {
    ...
    async getRewardsData(condition: any, orderBy: any = null) {
        ...
        let query = this.readReplicacampaignRewardRepository.createQueryBuilder('reward')
            .innerJoinAndMapOne(
                'reward.campaign',
    ...
    async getMultiRewarddatas(call_from:any = '', rewards:any = [], otherDatas:any = [], req:any){
        try{
                let {
                    activePlugins = [],
                    company_id = '',
    ...
    async getPaginateUsers(condition:any = '', fields:any = [], joinTale: any = [], paginationParam: PaginateWithReportInput) {
        ...
        try{
            ...
            const [result, total] = await queryResult.getManyAndCount();;
