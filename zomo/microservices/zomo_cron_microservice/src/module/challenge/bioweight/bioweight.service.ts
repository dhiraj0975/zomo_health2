import {
    ...
    BioWeightEntity, CommonArrayService,
    CommonFileService,
    tableConstant,
...
export class BioWeightService  extends BaseService<BioWeightEntity> {
    constructor(
        ...
        super(readReplicaBioWeightRepository, writeReplicaBioWeightRepository,'bioWeight', commonArrayService);
    }
    async save(data: any) {
    ...
    async update(condition: any, data: any) {
        data = await this.commonFileService.filterDataByEntityColumns(
            data,
            this.writeReplicaBioWeightRepository.metadata,
        );
        return await this.writeReplicaBioWeightRepository
    ...
    async listRecord(
        ...
        let query =
            this.readReplicaBioWeightRepository.createQueryBuilder('weight');
